package com.example.greads.notify;
...
import com.example.greads.activity.MainActivity;
...
public class NotificationDailyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        sendNotification(context, context.getString(R.string.app_name), "Lihat Berita hari ini!");
    }
