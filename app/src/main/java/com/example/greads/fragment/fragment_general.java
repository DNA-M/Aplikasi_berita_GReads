...
public class fragment_general extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void refresh(final String keyword) {
        ...
        if(keyword.length() > 0){
            ...
            call = api.getListAllNews("id", "12850cd010b54441aaeff6749dc99cd0");
        }
